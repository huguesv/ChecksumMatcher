...
public sealed class SevenZipFile
{
    static SevenZipFile()
    {
    ...
    public static Task CreateOrAppendAsync(string archiveFilePath, string itemFilePath, string itemName, CancellationToken ct)
    {
        ArgumentException.ThrowIfNullOrEmpty(archiveFilePath);

...
public partial class DatabaseStatsViewModel : ObservableObject
{
    ...
    public DatabaseStatsViewModel(IDatabaseService databaseService, IClipboardService clipboardService, DatabaseFolder folder, Action onCalculatingComplete)
    {
        ...
        this.ComputeFolderStatsAsync(folder, CancellationToken.None).SafeFireAndForget();
    }
    ...
    public void CopyToClipboard()
    {
        ...
        current.AppendLine(Localized.StatisticDatabaseCount);
        current.AppendLine(this.SummaryDatabaseCount.ToString());
        current.AppendLine();

        current.AppendLine(Localized.StatisticContainerCount);
        current.AppendLine(this.SummaryContainerCount.ToString());
        current.AppendLine();

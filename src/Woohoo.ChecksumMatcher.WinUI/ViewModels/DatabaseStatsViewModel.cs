...
public sealed partial class DatabaseStatsViewModel : ObservableObject
{
    ...
    public DatabaseStatsViewModel(IDatabaseService databaseService, IClipboardService clipboardService, ILogger logger, RomDatabase db)
    {
    ...
    public DatabaseStatsViewModel(IDatabaseService databaseService, IClipboardService clipboardService, ILogger logger, DatabaseFolder folder, Action onCalculatingComplete)
    {
        ArgumentNullException.ThrowIfNull(databaseService);
        ArgumentNullException.ThrowIfNull(clipboardService);
        ArgumentNullException.ThrowIfNull(logger);
        ...
        this.ComputeFolderStatsAsync(folder, CancellationToken.None).FireAndForget((ex) => this.logger.LogError(ex, "Error computing folder stats."));
    }

...
public partial class OfflineExplorerFolderViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private bool searchResultsVisible = false;

    [ObservableProperty]
    private bool isExpanded = false;

    public OfflineExplorerFolderViewModel(OfflineItem item, OfflineExplorerViewModel offlineExplorerViewModel, OfflineExplorerFolderViewModel? parentViewModel, ILocalSettingsService localSettingsService, IClipboardService clipboardService, DispatcherQueue dispatcherQueue)
    {
        this.debounceTimer = dispatcherQueue.CreateTimer();
        this.item = item;
        ...
        var showArchivesInTree = this.localSettingsService.ReadSetting<bool?>(SettingKeys.ExplorerShowArchiveInTree) ?? false;
    ...
    public AdvancedCollectionView SortedFolders;
    ...
    public AdvancedCollectionView SortedFoldersAndFiles;
    ...
    {
        this.clipboardService.SetText(this.item.Name);
    }

    [RelayCommand]
    public void CopyPathToClipboard()
    {
        this.clipboardService.SetText(this.item.Path);
    }

    private void SetSortDescriptions()
    {
        var direction = Enum.Parse<SortDirection>(this.localSettingsService.ReadSetting<string>(SettingKeys.ExplorerSortOrder) ?? SortDirection.Ascending.ToString());
        var priority = Enum.Parse<OfflineExplorerFolderSortPriority>(this.localSettingsService.ReadSetting<string>(SettingKeys.ExplorerFolderSortPriority) ?? OfflineExplorerFolderSortPriority.First.ToString());
        var archiveGrouping = Enum.Parse<OfflineExplorerArchiveGrouping>(this.localSettingsService.ReadSetting<string>(SettingKeys.ExplorerArchiveGrouping) ?? OfflineExplorerArchiveGrouping.WithFiles.ToString());
    ...
    class FolderAndFileComparer : System.Collections.IComparer
    {

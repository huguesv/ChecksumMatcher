...
public partial class OfflineExplorerFileViewModel : ObservableObject
{
    private readonly OfflineItem item;
    private readonly IClipboardService clipboardService;

    public OfflineExplorerFileViewModel(OfflineItem item, OfflineExplorerFolderViewModel? parentViewModel, IClipboardService clipboardService)
    {
        this.item = item;

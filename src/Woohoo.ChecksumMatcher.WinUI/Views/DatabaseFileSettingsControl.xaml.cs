...
public sealed partial class DatabaseFileSettingsControl : UserControl
{
    public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(nameof(ViewModel), typeof(DatabaseFileViewModel), typeof(DatabaseFileSettingsControl), new PropertyMetadata(null, OnViewModelChanged));

    public DatabaseFileSettingsControl()
    {
    ...
    {
        if (d is DatabaseFileSettingsControl control)
        {
        }
    }

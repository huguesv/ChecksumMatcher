...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        bool isPackaged = RuntimeHelper.IsMSIX;
        if (!isPackaged)
        {
            // If not running as a packaged app, set the AppUserModelID so that notifications work correctly.
            // Note: This must be called early in the app lifecycle, before any toast notifications are shown.
            _ = NativeMethods.SetCurrentProcessExplicitAppUserModelID("Woohoo.ChecksumMatcher.AUMID");
        }
        ...
        this.Host = Microsoft.Extensions.Hosting.Host.
            ...
            ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<IOperationListenerService, OperationListenerService>();
                ...
                // Views and ViewModels
                services.AddTransient<OfflineStorageFolderSelectionPage>();
                services.AddTransient<OfflineStorageFolderSelectionViewModel>();

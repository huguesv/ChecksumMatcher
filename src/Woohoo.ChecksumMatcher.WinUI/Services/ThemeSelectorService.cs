...
internal sealed class ThemeSelectorService : IThemeSelectorService
{
    ...
    {
        var themeName = this.localSettingsService.ReadSetting<string>(KnownSettingKeys.AppBackgroundRequestedTheme);
    ...
    {
        this.localSettingsService.SaveSetting(KnownSettingKeys.AppBackgroundRequestedTheme, theme.ToString());
    }
}

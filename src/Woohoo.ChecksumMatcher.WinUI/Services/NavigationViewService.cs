...
public class NavigationViewService : INavigationViewService
{
    ...
    public void Initialize(NavigationView navigationView)
    {
        ...
        _navigationView.BackRequested += this.OnBackRequested;
        _navigationView.ItemInvoked += this.OnItemInvoked;
    }
    ...
    public NavigationViewItem? GetSelectedItem(Type pageType)
    {
        if (_navigationView != null)
        {
            return this.GetSelectedItem(this._navigationView.MenuItems, pageType) ?? this.GetSelectedItem(this._navigationView.FooterMenuItems, pageType);
        }

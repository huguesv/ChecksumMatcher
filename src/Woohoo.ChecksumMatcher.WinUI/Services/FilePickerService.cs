...
{
    public async Task<string?> GetOpenFilePathAsync(params (string Name, string ExtensionList)[] filters)
    {
    ...
    public async Task<string?> GetOpenFolderPathAsync()
    {
    ...
    public async Task<string?> GetSaveFilePathAsync(params (string Name, string ExtensionList)[] filters)
    {

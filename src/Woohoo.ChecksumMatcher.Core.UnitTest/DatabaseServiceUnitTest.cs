...
#pragma warning restore CS0067
        ...
        public Task<OfflineDiskCreateResults> CreateDiskAsync(string sourceFolderPath, string targetDiskFilePath, string diskName, OfflineDiskCreateSettings settings, CancellationToken ct)
        {
            throw new NotImplementedException();
        }

...
internal static class ContainerExtensionProvider
{
    private static readonly IContainer FolderContainer = new CachingContainer(new FolderContainer());

    private static readonly ImmutableArray<IContainer> CompressedContainers =
    [
        new CachingContainer(new SharpZipContainer()),
        new CachingContainer(new SevenZipContainer()),
    ];

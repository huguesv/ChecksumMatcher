...
internal class CachingContainer : IContainer
{
    ...
    public async Task CalculateChecksumsAsync(FileInformation file, CancellationToken ct)
    {
        ...
        {
            file.ReportedCRC32 = cacheItem.ReportedCRC32;
            file.ReportedDiskSHA1 = cacheItem.ReportedDiskSHA1;
    ...
    private class CacheItem
    {
        ...
        {
            this.ReportedCRC32 = file.ReportedCRC32;
            this.ReportedDiskSHA1 = file.ReportedDiskSHA1;
        ...
        public byte[] ReportedCRC32 { get; }

        public byte[] ReportedDiskSHA1 { get; }

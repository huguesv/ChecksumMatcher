...
public static class KnownSettingKeys
{
    ...
    public const string RedumpSystems = nameof(RedumpSystems);
    ...
    public const string UseWinUIFolderPicker = nameof(UseWinUIFolderPicker);
    public const string Win32FolderPickerLastLocations = nameof(Win32FolderPickerLastLocations);

    // Database file/folder settings
    public const string RebuildSettings = nameof(RebuildSettings);

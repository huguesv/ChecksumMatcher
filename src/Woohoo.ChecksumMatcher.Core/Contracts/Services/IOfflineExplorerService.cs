...
public interface IOfflineExplorerService
{
    ...
    Task<OfflineDiskCreateResults> CreateDiskAsync(string sourceFolderPath, string targetDiskFilePath, string diskName, OfflineDiskCreateSettings settings, CancellationToken ct);
}

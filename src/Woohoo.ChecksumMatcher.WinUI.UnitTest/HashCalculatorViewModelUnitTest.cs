...
public class HashCalculatorViewModelUnitTest
{
    ...
    public async Task SelectFile()
    {
        ...
        sut.Results[0].Hashes.Should().BeEquivalentTo<HashCalculatorChecksumViewModel>(
        [
            new() { Algorithm = "CRC32", Value = "0d968558" },
            new() { Algorithm = "MD5", Value = "348a9791dc41b89796ec3808b5b5262f" },
            new() { Algorithm = "SHA1", Value = "b376885ac8452b6cbf9ced81b1080bfd570d9b91" },
            new() { Algorithm = "SHA256", Value = "5341e6b2646979a70e57653007a1f310169421ec9bdd9f1a5648f75ade005af1" },
        ]);
    }
